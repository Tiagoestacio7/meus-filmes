        ...
        const cardMovies = data.results.map(function (i){
            ...
            <div class="col-6 col-sm-4 col-md-3">
                <div class="movie-card">
                    <img src="https://media.themoviedb.org/t/p/w440_and_h660_face/${i.backdrop_path}" class="card-img-top" alt="${i.original_name}">
                    <div class="card-body movie-info">
                    <div class="movie-title">${i.original_name}</div>
                    <div class="movie-date">${formatDate(i.first_air_date)}</div>
            </div>
        </div>`
